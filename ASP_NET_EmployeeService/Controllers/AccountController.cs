...
using ASP_NET_EmployeeService.Models;
using ASP_NET_EmployeeService.Providers;
using ASP_NET_EmployeeService.Results;

namespace ASP_NET_EmployeeService.Controllers
{
    [Authorize]
